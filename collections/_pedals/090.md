...
* **RATE** - ThisChorus speed from slow to fast.
* **DEPTH** - ThisChorus depth from min to max.
* **BLEND** - ThisMix of dry, chorus and vibrato. CCW is dry (no modulation), 1/4 up to middle is chorus and fully CW is vibrato.
* **T1** - ThisSets he bias of the chorus effect
