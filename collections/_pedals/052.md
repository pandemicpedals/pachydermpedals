...
See the build writup [here]({{ site.url }}{{ site.baseurl }}/tutorials/2021-02-09-test-box/).
...
* **Wave**: This is the shape of the wave for the frequency generator. Choose square, triangle, sharp sine, and sine.
* **Generator On/Off** switch
* **Frequency**: The frequency you want to generate from inaudible low to inaudible high
* **Bypass**: switch to bypass or send power and signal to the test circuit
* **Audio Probe**: switch - pink probe on, brown probe off. Unless you are into that kind of thing.
